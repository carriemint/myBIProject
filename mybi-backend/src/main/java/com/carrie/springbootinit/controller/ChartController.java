...
import com.carrie.springbootinit.bimq.BiMessageProducer;
import com.carrie.springbootinit.model.dto.chart.*;
import com.carrie.springbootinit.model.vo.biResponse;
...
import com.carrie.springbootinit.constant.CommonConstant;
...
import com.carrie.springbootinit.manager.RedisLimitManager;
import com.carrie.springbootinit.model.dto.chart.*;
...
import com.carrie.springbootinit.utils.SqlUtils;
...
//        chartService.validChart(chart, false);
    ...
    public BaseResponse<biResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        String suffix = FileUtil.getSuffix(originalFilename);
        //合法的文件后缀
        List<String> validSuffix = Arrays.asList("xlsx", "xls");
        ...
        //限流
        //每个请求获取一个令牌，没获得就抛异常。
        redisLimitManager.doRateLimit("genChartByAiAsync_" + loginUser.getId());
        System.out.println("000000000000000");
        System.out.println("genChartByAiAsync_" + loginUser.getId());
        //用户输入
        StringBuilder userInput = new StringBuilder();
        userInput.append("分析需求：").append('\n');
        String userGoal = goal;
        ...
        boolean saveResult = chartService.save(chart);
        ThrowUtils.throwIf(!saveResult, ErrorCode.SYSTEM_ERROR, "图表保存失败");
        //TODO:处理任务队列满了，抛异常的情况（否则前端会显示异常）
        //提交任务
