package com.carrie.springbootinit.openai;
...
public class ChatGptService {
    ...
    private OpenAiClient getOpenAiClient() {
        ...
        return OpenAiClient.builder()
                //支持多key传入，请求时候随机选择
                //ChatGpt开发密钥
                //Collections.singletonList("sk-9iSIiSFFgjGvqw67015203F3Dc234f58A0A77b6b3bCe40D6")
                .apiKey(Arrays.asList("sk-9iSIiSFFgjGvqw67015203F3Dc234f58A0A77b6b3bCe40D6"))
                //自定义key的获取策略：默认KeyRandomStrategy
                .keyStrategy(new KeyRandomStrategy())
                .okHttpClient(okHttpClient)
                //自己做了代理就传代理地址，没有可不不传
                //测试代理地址https://dgr.life/
                .apiHost("https://chat.xty.app/api/openai/")
                .build();
    }
